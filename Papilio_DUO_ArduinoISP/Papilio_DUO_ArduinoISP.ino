/*
 ...
 To use this sketch do the following steps:
  Select the AVR8 Shifty board type for the Papilio DUO.
  
  Here is a video walking through the process:
  http://www.youtube.com/watch?v=9yv4AqjKTrI&hd=1
...
void setup() {
  ...
  //SPI1_cs_LOC=B2;      //AL4 for Wing Slot AL 
