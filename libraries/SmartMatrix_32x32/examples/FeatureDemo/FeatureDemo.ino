...
#if (DEMO_INTRO == 1)
    // "SmartMatrix Demo"
    matrix.setScrollColor(defaultScrollColor);
...
//        matrix.scrollText("Fill Screen", 1);
...
#if (DEMO_BRIGHTNESS == 1)
    {
        ...
        while (millis() - currentMillis < transitionTime) {
            ...
            matrix.fillScreen(white);
            matrix.drawString(0, 16, black, value);
            matrix.drawString(0, 24, black, percent);
            matrix.swapBuffers(true);
        }
