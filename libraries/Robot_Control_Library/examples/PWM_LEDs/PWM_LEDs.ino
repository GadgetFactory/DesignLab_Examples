...
void setup() {
  ...
  Robot_Control_Library.setPWMDuty(0, 55);
  Robot_Control_Library.setPWMDuty(1, 127);
  Robot_Control_Library.setPWMDuty(2, 55);
  Robot_Control_Library.setPWMDuty(3, 55);
  Robot_Control_Library.setPWMDuty(4, 55);
  Robot_Control_Library.setPWMDuty(5, 55);
  Robot_Control_Library.setPWMDuty(6, 55);
  
}

void loop() {
  Robot_Control_Library.setPWMDuty(0, Robot_Control_Library.getPulseCount(0));
  
  Serial.println(Robot_Control_Library.getPWMDuty(0),HEX);  
